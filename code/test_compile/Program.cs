...
class Program
{
    static void Main(string[] args)
    {
        ...
        string docPath = "..\\..\\..\\..\\python\\"+project_name+".py";
        string output_path = "..\\..\\..\\..\\python";


        Node node = new Node("keys[pygame.K_m]","running = False", "Reset");
        Node node2 = new Node("keys[pygame.K_d]","player_pos.x = 100", "TP");
    ...
    public static void Compile(string project_path, string output_path,string json)
    {
        ...
        string pathToScript = "..\\powershell\\script.ps1";

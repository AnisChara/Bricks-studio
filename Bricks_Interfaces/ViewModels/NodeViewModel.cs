...
namespace Bricks_Interfaces.ViewModels
{
    public class NodeViewModel : BaseNotifyPropertyChanged
    {
        ...
        public void ActualiseDrag(System.Windows.Point e, double width, double height)
        {
            ...
            if (may_fuse == true && selectedBrick.Image == "A:\\Code\\bricks-studio\\assets\\lego_rouge.png" && entity_collided.Image == "A:\\Code\\bricks-studio\\assets\\lego_bleu.png") 
            { 
            ...
            if (may_fuse == true && selectedBrick.Image == "A:\\Code\\bricks-studio\\assets\\lego_bleu.png" && entity_collided.Image == "A:\\Code\\bricks-studio\\assets\\lego_rouge.png")
            {
                rect.Visibility = System.Windows.Visibility.Visible;

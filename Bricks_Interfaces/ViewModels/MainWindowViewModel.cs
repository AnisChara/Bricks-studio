...
namespace Bricks_Interfaces.ViewModels
{
    public class MainWindowViewModel : BaseNotifyPropertyChanged
    {
        ...
        public static string project_path = formattedPath +"./..\\..\\..\\..\\code\\python\\index.py";// a rendre modulable
        public static string output_path = formattedPath + "./../../../../code/python";
